...
const fasilitas  = [
    ...
    {
      name: 'Kantin', 
      url_image: 'http://localhost:3000/img/fasilitas/kantin.jpg', 
      fakultas: 'FIP',
    },
    {
      name: 'Auditorium', 
      url_image: 'http://localhost:3000/img/fasilitas/Auditorium.png', 
      fakultas: 'FPIPS',
    }, 
    {
      name: 'Lab. IPS', 
    ...
    {
      name: 'Ruang Kesenian', 
      url_image: 'http://localhost:3000/img/fasilitas/kesenian.jpeg',   
      fakultas: 'FPSD',
    }, 
    {
      name: 'Amphitheater', 
      url_image: 'http://localhost:3000/img/fasilitas/amphiteater.jpg', 
      fakultas: 'FPSD',
    },
    {
      name: 'Gelanggang', 
    ...
    {
      name: 'Lapangan Tenis', 
      url_image: 'http://localhost:3000/img/fasilitas/lapangan.png', 
      fakultas: 'FPOK',
    },   
    {
